...
class ActionsController < ApplicationController
  ...
  def action_params
    params.require(:workflow_action).permit(:title, :description, :order, :content, :has_ai_action, :best_model_picker, :allow_prompting, :has_prompt_generator, :artifact_name,  rag_artifact_ids: [], content_artifact_ids: [], ai_action_attributes: [ :id, :ai_model, :best_model_picker, :custom_attributes ])
  end
